...
# Stacks
alias p="pnpm"
alias stacks="pnpm stacks"
alias stx="pnpm stacks"
alias pa="pnpm stacks"
alias art="pnpm stacks"
alias artisan="pnpm stacks"
alias pc="pnpm stacks commit"
alias pr="pnpm stacks release"
alias pd="pnpm stacks dev"
alias pdc="pnpm stacks dev:components"
alias pb="pnpm stacks build"
alias pl="pnpm stacks lint"
alias plf="pnpm stacks lint:fix"
